...
class check_query_ui(object):
    def setupUi(self, Form):
        ...
        self.ok.setGeometry(QtCore.QRect(250, 380, 112, 34))
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "查看缺勤记录"))
        ...
        self.label_6.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:600;\">查看缺勤记录</span></p></body></html>"))

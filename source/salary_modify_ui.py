...
class salary_modify_ui(object):
    def setupUi(self, Form):
        ...
        self.OK.clicked.connect(Form.save_to_database)
        QtCore.QMetaObject.connectSlotsByName(Form)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "修改工资"))
        self.label_4.setText(_translate("Form", "底薪"))
        self.label_5.setText(_translate("Form", "奖金"))
        self.OK.setText(_translate("Form", "保存更改"))
        self.label_6.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:600;\">修改工资</span></p></body></html>"))

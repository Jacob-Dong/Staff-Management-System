...
class dep_add_ui(object):
    def setupUi(self, Form):
        ...
        self.add.setGeometry(QtCore.QRect(430, 410, 112, 41))
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "添加部门"))
        ...
        self.label_7.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">添加部门</span></p></body></html>"))

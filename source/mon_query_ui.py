...
class mon_query_ui(object):
    def setupUi(self, Form):
        ...
        self.ok.setGeometry(QtCore.QRect(390, 450, 112, 34))
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "查看优秀员工"))
        ...
        self.label_6.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">查看优秀员工</span></p></body></html>"))

...
class sys_admin_modify_ui(object):
    def setupUi(self, Form):
        ...
        self.update.setGeometry(QtCore.QRect(330, 330, 112, 41))
        self.update.setObjectName("update")

        self.retranslateUi(Form)
        self.update.clicked.connect(Form.save_to_database)
        QtCore.QMetaObject.connectSlotsByName(Form)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "修改管理员信息"))
        ...
        self.label_8.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:600;\">修改管理员信息</span></p></body></html>"))
        self.update.setText(_translate("Form", "保存修改"))

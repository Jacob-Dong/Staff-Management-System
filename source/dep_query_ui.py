...
class dep_query_ui(object):
    def setupUi(self, Form):
        ...
        self.label_7.setGeometry(QtCore.QRect(220, 17, 141, 41))
        self.label_7.setObjectName("label_7")
        self.ok = QtWidgets.QPushButton(Form)
        self.ok.setGeometry(QtCore.QRect(430, 410, 112, 41))
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "查看部门信息"))
        ...
        self.label_7.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">部门信息</span></p></body></html>"))

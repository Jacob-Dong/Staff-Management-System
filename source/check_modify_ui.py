...
class check_modify_ui(object):
    def setupUi(self, Form):
        ...
        self.add.clicked.connect(Form.save_to_database)
        self.retranslateUi(Form)
        QtCore.QMetaObject.connectSlotsByName(Form)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "修改缺勤记录"))
        ...
        self.label_6.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:600;\">修改缺勤记录</span></p></body></html>"))
        self.add.setText(_translate("Form", "保存修改"))

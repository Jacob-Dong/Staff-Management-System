...
class staff_add_ui(object):
    def setupUi(self, Form):
        ...
        self.add.setGeometry(QtCore.QRect(540, 583, 171, 41))
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "添加新成员"))
        self.mail.setText(_translate("Form", "邮箱"))
        self.dep.setText(_translate("Form", "部门"))
        self.title.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600;\">添加新成员</span></p></body></html>"))
        self.salary.setText(_translate("Form", "工资"))
        self.add.setText(_translate("Form", "添加员工"))
